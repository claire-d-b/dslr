...
def get_cost() -> any:
    ...
    real_houses = [1 if houses.index(h) == HOUSE_INDEX else 0 for h in lhs]
    # print("real houses", real_houses)
    # Choose here 'Gryffindor', 'Hufflepuff", "Ravenclaw", "Slytherin"
    # depending on the house you want to analyze below
    name = HOUSE
